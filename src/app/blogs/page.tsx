        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-20 bg-gray-50 rounded-3xl border border-gray-100">
              ...
              <p className="text-gray-500">Check back later for new stories and updates.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {blogs.map((blog) => (
                ...
                >
                  <Link href={`/blogs/${blog.slug}`} className="block relative aspect-[16/9] overflow-hidden bg-gray-100">
                    {blog.image ? (
                      <img 
                        src={blog.image} 
                        alt={blog.title} 
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="inline-block px-3 py-1 bg-white/90 backdrop-blur-sm text-cyan-700 text-xs font-bold uppercase tracking-wider rounded-full shadow-sm">
                  ...
                  <div className="flex flex-col flex-1 p-8">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center font-semibold text-cyan-600 hover:text-cyan-700 group/link mt-auto"
                    >
                      Read Full Article
