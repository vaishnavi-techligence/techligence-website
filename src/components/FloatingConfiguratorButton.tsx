...
export default function FloatingConfiguratorButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 md:bottom-6 md:right-6 z-50" style={{ animationDuration: '4s' }}>
      <a 
        href="/configurator" 
        target="_blank"
        rel="noopener noreferrer"
        className="relative flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white border border-cyan-300/50 px-5 py-3 rounded-full transition-all duration-300 shadow-[0_0_20px_rgba(0,240,255,0.6)] hover:shadow-[0_0_28px_rgba(0,240,255,0.8)] group cursor-pointer hover:scale-105"
      >
